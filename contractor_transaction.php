            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        $contractor_transaction = mysqli_fetch_assoc($result)
                        ?>
                        ...
                        <div class="ibox-content">
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <form method="post" action="php/edit_contractor_transaction.php?transaction_id=<?php echo $contractor_transaction['id']?>" class="form-horizontal">
                                    <div class="form-group" id="data_1">
                                        <span class="arabic">
                                        <label class="col-sm-2 control-label">التاريخ </label>
                                        <div class="col-sm-10">
                                            <div class="input-group date">
                                                <input type="text" id="date" class="form-control" name="expenses_date" value="<?php echo $contractor_transaction['date_1']?>" required>
                                        ...
                                        <div class="col-sm-10">
                                            <select class="chosen-select form-control" name="reason_id">
                                                ...
                                                foreach ($results as $reason){
                                                    ?>
                                                    <option  <?php if ($contractor_transaction['reason_id']==$reason['id']) echo "selected" ?> value="<?php echo $reason["id"];?>"><?php echo $reason["name"];?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <span class="arabic">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="expenses_value"   value="<?php echo $contractor_transaction['value']?>" required/>
                                            </div>
                                        </span>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="chosen-select form-control" name="site_id">
                                                    ...
                                                    foreach ($results as $site){
                                                        ?>
                                                        <option <?php if ($contractor_transaction['site_id']== $site["id"]) echo "selected";?> value="<?php echo $site["id"];?>"><?php echo $site["name"];?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if ($contractor_transaction['removed']=="1"){
                                            ?>
                                            <div class="col-sm-4 col-sm-offset-2">
                                                <a data-toggle='modal' class=" pull-right btn btn-info" href='' onclick="undelete_expense(<?php echo $contractor_transaction['id'] ?>)">
                                                        <span class="arabic">
                                                            <i class="ace-icon fa fa-check bigger-110"></i>
                                                   إستعادة السجل
                                                        </span>
                                            ...
                                            ?>
                                            <div class="col-sm-4 col-sm-offset-2">
                                                <a data-toggle='modal' class=" pull-right btn btn-danger" href='' onclick="delete_expense(<?php echo $contractor_transaction['id'] ?>)">
                                                        <span class="arabic">
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    swal("Deleted!", "تم حذف السجل بنجاح.", "success");
                    function explode(){
                        window.location.href = "php/delete_contractor_transaction.php?expense_id="+id;
                    }
