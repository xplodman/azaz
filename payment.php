            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        $result=mysqli_query($con, "Select payment.due_date As payment_due_date,
                    ...
                    Where payment.id =$payment_id");
                        ...
                        <div class="ibox-content">
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <form method="post" id="form_submit" action="php/edit_payment.php?payment_id=<?php echo $payment_info['payment_id']; ?>" class="form-horizontal">
                                    ...
                                    <div class="form-group" id="data_1">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group date">
                                                <input type="text" id="date" class="form-control" name="due_date"  value="<?php echo $payment_info['payment_due_date']; ?>">
                                    ...
                                    <div class="form-group" id="data_1">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group date">
                                                <input type="text" id="date" class="form-control" name="payment_date" value="<?php echo $payment_info['payment_payment_date']; ?>">
                                                <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                                </span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <span class="arabic">
                                            ...
                                            <div class="col-sm-10">
                                                <input required class="form-control" type="number" id="form-field-2" name="payment_value" value="<?php echo $payment_info['payment_value']; ?>"/>
                                            </div>
                                        </span>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        switch ($payment_info['payment_status']) {
                                            case "0":
                                                ?>
                                                <div class="col-sm-4 col-sm-offset-2">
                                                    <a data-toggle='modal' class=" pull-right property_payment_receive btn btn-info" href='#property_payment_receive' data-id='<?php echo $payment_info['payment_id']; ?>'>
                                                        <span class="arabic">
